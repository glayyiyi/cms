...
add_filter('weixin_builtin_reply', 'wpjam_weixin_air_quality_builtin_reply');
function wpjam_weixin_air_quality_builtin_reply($weixin_builtin_replies){
    $weixin_builtin_replies['kq'] = $weixin_builtin_replies['空气'] = array('type'=>'prefix',   'reply'=>'获取空气质量',  'function'=>'wpjam_weixin_air_quality_reply');
...
function wpjam_weixin_air_quality_reply($keyword){
    global $wechatObj;
