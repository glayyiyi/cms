...
class Wechat {
	...
	public function responseText($content, $funcFlag = 0) {
		echo new TextResponse ( $this->fromUsername, $this->toUsername, $content, $funcFlag );
	}
	...
	public function responseMusic($title, $description, $musicUrl, $hqMusicUrl, $funcFlag = 0) {
		echo new MusicResponse ( $this->fromUsername, $this->toUsername, $title, $description, $musicUrl, $hqMusicUrl, $funcFlag );
	}
	...
	public function responseNews($items, $funcFlag = 0) {
		echo new NewsResponse ( $this->fromUsername, $this->toUsername, $items, $funcFlag );
	}
