	    ...
	    <li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode(' ', $classes ); ?>">
	        ...
	        <div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
	            ...
	            ?>      
							...
							<p class="field-custom description description-wide">
								<?php
									$value = $item->recentpost;
									if($value != "") $value = "checked='checked'";
								?>
									<label for="edit-menu-item-recentpost-<?php echo $item_id; ?>">
										<input type="checkbox" id="edit-menu-item-recentpost-<?php echo $item_id; ?>" class="code edit-menu-item-custom" name="menu-item-recentpost[<?php echo $item_id; ?>]" value="recentpost" <?php echo $value; ?> />
										<?php _e( "Display featured posts", 'qode' ); ?>
									</label>
							</p>
							<p class="field-custom description description-wide">
								<?php
								...
								?>
									<label for="edit-menu-item-numberofposts-<?php echo $item_id; ?>">
										<input type="text" id="edit-menu-item-numberofposts-<?php echo $item_id; ?>" class="code edit-menu-item-custom" name="menu-item-numberofposts[<?php echo $item_id; ?>]" value="<?php echo esc_attr( $item->numberofposts ); ?>" />
										<?php _e( "Put number of featured posts", 'qode' ); ?>
									</label>
							</p>
							<p class="field-custom description description-wide">
								<?php
									$value = $item->featuredpostscategory;
									
								?>
									<label for="edit-menu-item-featuredpostscategory-<?php echo $item_id; ?>">
										<?php _e( 'Featured Posts Category', 'qode' ); ?><br />
										<select id="edit-menu-item-type-menu<?php echo $item_id; ?>" name="menu-item-featuredpostscategory[<?php echo $item_id; ?>]">
											<option value="" <?php if(esc_attr($item->featuredpostscategory) == ""){echo 'selected="selected"';} ?>></option>
											<?php $categories = get_categories();
												foreach ( $categories as $category ) { ?>
													<option value="<?php echo $category->cat_ID ?>" <?php if(esc_attr($item->featuredpostscategory) == $category->cat_ID){echo 'selected="selected"';} ?>><?php echo $category->name ?></option>
												<?php } ?>
										</select>
									</label>
							</p>
