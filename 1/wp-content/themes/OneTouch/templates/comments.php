...
<?php if (comments_open()) : ?>
  <section id="respond">
    <h3><?php comment_form_title(__('Leave a Reply', 'roots'), __('Leave a Reply to %s', 'roots')); ?></h3>
      ...
      if ($NHP_Options->get("facebook_share_comments")=="1") { ?>
          <div id="fb-root"></div>
    ...
    <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
      ...
      <p><?php printf(__('Logged in as <a href="%s/wp-admin/profile.php">%s</a>.', 'roots'), get_option('siteurl'), $user_identity); ?>
      ...
      <p>
        <button name="submit" class="button" tabindex="5"><?php _e('Submit Comment', 'roots'); ?></button>
      </p>
